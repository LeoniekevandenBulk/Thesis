...
% This code is used to calcute the unnormalized Motion energy features of
% the training set data in order to be able to retrieve the mean and
% variance to z-score the test data with.
...
to_dir = 'MotionEnergyTrainingVideosUnnormalized/';
...
for i = 1:size(files,1)
    ...
    % Try to read the training video
    try
    ...
    % Save unnormalized result to folder
    S_fin = S_ds;
    save_path = strcat(to_dir,'Unnormalized_ME_',file_name);
